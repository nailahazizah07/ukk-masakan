...
?>
  ...
  <head>
    ...
    <title>Kasir-Resto | Project UKK</title>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="dist/img/jeno.jpeg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Azizah Nailah Ramadhani</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="dist/img/jeno.jpeg" class="img-circle" alt="User Image">

                    <p>
                      Azizah Nailah R - Projek UKK PHP Native
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            ?>
              <li class="treeview">
                <a href="#">
                  <i class="glyphicon glyphicon-shopping-cart"></i> <span>Pesanan</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                  <li><a href="index.php?page=data_pesan"><i class="glyphicon glyphicon-education"></i> <span>Pesan Masakan</span></a></li>
            ...
            ?>
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="index.php?page=data_order"><i class="glyphicon glyphicon-education"></i> <span>Data Order Resto</span></a></li>
